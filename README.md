...
**[Vet_clinic]** "It is a SQL project where I created a simple animals table, and Inserted some animals data into it, then inquired to filter data."
...
```sh
 $ git clone https://github.com/AbdelazizSoliman/Vet-clinic.git
 $ cd file-name
```
### Deployment
...
Feel free to check the [issues page](https://github.com/AbdelazizSoliman/Vet-clinic/issues).
...
I would like to thank Microverse community for support.
