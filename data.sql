...
FROM vets
JOIN species ON vets.name = 'William Tatcher' AND species.name = 'Pokemon';

INSERT INTO specializations (vet_id, species_id)
SELECT vets.id, species.id 
FROM vets
JOIN species ON vets.name = 'Stephanie Mendez' AND species.name = 'Pokemon';

INSERT INTO specializations (vet_id, species_id)
SELECT vets.id, species.id 
FROM vets
JOIN species ON vets.name = 'Stephanie Mendez' AND species.name = 'Digimon';

INSERT INTO specializations (vet_id, species_id)
SELECT vets.id, species.id 
FROM vets
JOIN species ON vets.name = 'Jack Harkness' AND species.name = 'Digimon';
